...
belajar tentang NLP.
** Blog/website
- [[http://bahasa.cs.ui.ac.id/about.php][Pusat Bahasa UI]]
** PDF
- [[https://arxiv.org/pdf/1103.0398v1.pdf][Natural Language Processing (almost) from Scratch]]
** Video (Youtube)
- [[http:https://www.youtube.com/results?search_query=pemrosesan+bahasa+alami][Youtube search result for PBA]]
- [[https://www.youtube.com/watch?v=zv16Xyph7Ss][Sentiment Analysis of Social Media Texts Part 1]]
